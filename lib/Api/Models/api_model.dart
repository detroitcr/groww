...
ApiPracticeModel apiPracticeModelFromJson(String str) =>
    ApiPracticeModel.fromJson(json.decode(str));

String apiPracticeModelToJson(ApiPracticeModel data) =>
...
class ApiPracticeModel {
  ...
  factory ApiPracticeModel.fromJson(Map<String, dynamic> decodedData) =>
      ApiPracticeModel(
        ...
        data:
            List<Datum>.from(decodedData["data"].map((x) => Datum.fromJson(x))),
